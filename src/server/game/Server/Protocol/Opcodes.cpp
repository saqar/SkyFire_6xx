...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ADDON_INFO,                         0x0287, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                0x030B, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_TIMEZONE_INFORMATION,           0x04E6, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TUTORIAL_FLAGS,                     0x0546, STATUS_NEVER    ); 

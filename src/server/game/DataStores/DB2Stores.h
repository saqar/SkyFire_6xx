...
extern DB2Storage<GarrAbilityCategoryEntry> sGarrAbilityCategoryStore;
...
extern DB2Storage<GarrFollItemSetEntry> sGarrFollItemSetStore;
...
extern DB2Storage<GarrMissionTypeEntry> sGarrMissionTypeStore;

...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_PLACED,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_REMOVED,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLACE_BUILDING_RESULT,         0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_ARCHITECT,                0x0000, STATUS_NEVER    );

...
=======
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_AUTO_REPEAT_SPELL,                            0x0939, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAutoRepeatSpellOpcode  ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_UNDELETE_COOLDOWN,                              0x19A9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCharUndeleteCooldownOpcode   ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RAID_MARKER,                                   0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_ENABLE,                                  0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_ENTER_INSTANCE,                          0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_EXIT_INSTANCE,                           0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOG_DISCONNECT,                                      0x04D5, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                                    0x0000, STATUS_UNHANDLED, PROCESS_THREADSAFE,   &WorldSession::HandleRealmNameQueryOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_NEXT_CINEMATIC_CAMERA,                               0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleNextCinematicCamera          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PING,                                                0x0416, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                                         0x1BB2, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                                      0x09AC, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix                ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_INSPECT_RATED_BG_STATS,                      0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PARTY_MEMBER_STATS,                          0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPartyMemberStatsOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PVP_OPTIONS_ENABLED,                         0x120C, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestPvpOptions            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PLAYER_DECLINED_NAMES,                           0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetPlayerDeclinedNames       );
    DEFINE_OPCODE_HANDLER(CMSG_SET_PREFERED_CEMETERY,                               0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_SET_PRIMARY_TALENT_TREE,                             0x0AC5, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandeSetTalentSpecialization       ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SPECIALIZATION,                              0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_UNREGISTER_ALL_ADDON_PREFIXES,                       0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUnregisterAddonPrefixesOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_ACCOUNT_DATA,                                 0x12A1, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateAccountData            ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_MISSILE_TRAJECTORY,                           0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateMissileTrajectory      );
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_PROJECTILE_POSITION,                          0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateProjectilePosition     );
    DEFINE_OPCODE_HANDLER(CMSG_USED_FOLLOW,                                         0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_VIOLENCE_LEVEL,                                      0x0000, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleViolenceLevel                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_LEARN_TALENT,                                    0x08D6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetLearnTalent               ); // 6.0.3 19116
    ...
    ///< Battle Pay
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,                         0x1389, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBaattlePayProductListQuery   ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PURCHASE_LIST,                        0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET,            0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_SELECT_CHOICE,               0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_START_PURCHASE,                           0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
...
>>>>>>> remotes/origin/master
    ...
    ///< Garrison & Shipment
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_ALL_READY_SHIPMENTS,                        0x0AE6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteAllReadyShipment     ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CREATE_SHIPMENT,                                     0x06E3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCreateShipment               ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_CREATE_SHIPMENT_CHEAT,                               0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_GET_SHIPMENT_INFO,                                   0x068B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetShipmentInfo              ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_SHIPMENT_NPC,                                   0x03D9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOpenShipmentNpc              ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING,                    0x095A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrAssignFollower           ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_GARR_COMPLETE_MISSION,                               0x02C2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrCompleteMission          ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_GENERATE_RECRUITS,                              0x0472, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrGenerateRecruits         ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_MISSION_BONUS_ROLL,                             0x102C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrMissionBonusRoll         ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_PURCHASE_BUILDING,                              0x04A2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrPurchaseBuilding         ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_GARR_RECRUIT_FOLLOWER,                               0x028E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRecruitFollower          ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING,                  0x01BB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRemoveFollower           ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA,      0x16F2, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRequestBlueprintData); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_SET_BUILDING_ACTIVE,                            0x041A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrSetBuildingActive        ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_START_MISSION,                                  0x1624, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrStartMission             ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_GARR_SWAP_BUILDING,                                  0x09BD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrSwapBuildings            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GET_GARR_INFO,                                       0x0623, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrGetInfo                  ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_UPGRADE_GARR,                                        0x0526, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrUpgrade                  ); // 6.0.3 19116
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENT_CONTROL_UPDATE,                           0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE,                                 0x0912, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                                   0x0B06, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOTD,                                            0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAY_OBJECT_SOUND,                               0x1C8A, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RANDOMIZE_CHAR_NAME,                             0x0BAA, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRIGGER_CINEMATIC,                               0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_ACCOUNT_DATA_COMPLETE,                    0x0000, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS,                              0x1E89, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_ACTION_SOUND,                                0x0D39, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_LEARNED_SPELL,                               0x1822, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_SPELLS,                                      0x0174, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT,                                     0x1027, STATUS_UNHANDLED); // 6.0.3 19116
...
>>>>>>> remotes/origin/master
    ...
    ///< Garrison & Shipment
    DEFINE_OPCODE_HANDLER(SMSG_COMPLETE_SHIPMENT_RESPONSE,                      0x1901, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_CREATE_SHIPMENT_RESPONSE,                        0x1BAB, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENT_INFO_RESPONSE,                      0x1B81, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE,                  0x11AB, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP,                   0x1974, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_RESULT,                        0x0709, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_ARCHITECT,                             0x0523, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_MISSION_NPC,                           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLACE_BUILDING_RESULT,                      0x0082, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_PLACED,                                0x0583, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_REMOVED,                               0x0513, STATUS_NEVER    ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GET_GARR_INFO_RESULT,                            0x0521, STATUS_NEVER    ); // 6.0.3 19116

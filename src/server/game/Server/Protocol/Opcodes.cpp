...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ADD_IGNORE,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddIgnoreOpcode              );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_DELETE_PET,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetDelete              );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_MODIFY_NAME,             0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetModifyName          );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_QUERY_NAME,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetQueryName           );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_BATTLE_SLOT,         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSetBattleSlot       );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_FLAGS,               0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSetFlags            );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SUMMON_COMPANION,        0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSummonCompanion     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_UNDELETE_COOLDOWN,             0x19A9, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharUndeleteCooldownOpcode   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_PET_SPECIALIZATION_GROUP,     0x08D6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandeLearnPetSpecializationGroup   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_QUERY,                     0x1433, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetNameQuery                 ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_READ_ITEM,                          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReadItem                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PET_INFO,                   0x0E37, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPetInfoOpcode         ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PVP_OPTIONS_ENABLED,        0x120C, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleRequestPvpOptions            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TEXT_EMOTE,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTextEmoteOpcode              );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DELETED,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_DENINED,    0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUERY_NAME_RESPONSE,     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_SLOT_UPDATE,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UPDATE,                  0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_LEARNED_SPELLS,                 0x1822, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_SPELLS,                         0x0174, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                   0x0025, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_UNLEARNED_SPELLS,               0x011B, STATUS_NEVER    ); // 6.0.3 19103

...
// All Gt* DBC store data for 132 levels, some by 100 per class/race
...
typedef std::map<uint32, std::list<uint32> > TalentOverrideSpellMap;
typedef std::map<uint32, std::list<uint32> > TalentLinkedSpells;
#endif

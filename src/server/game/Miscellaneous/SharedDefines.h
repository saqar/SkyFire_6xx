...
enum SpellCastResult
{
    ...
    SPELL_FAILED_GARRISON_FOLLOWER_MAX_LEVEL     = 45,
    SPELL_FAILED_GARRISON_FOLLOWER_MAX_ITEM_LEVEL = 46,
    SPELL_FAILED_GARRISON_FOLLOWER_MAX_QUALITY   = 47,
    SPELL_FAILED_GARRISON_FOLLOWER_NOT_MAX_LEVEL = 48,
    SPELL_FAILED_GARRISON_FOLLOWER_HAS_ABILITY   = 49,
    SPELL_FAILED_GARRISON_FOLLOWER_NO_OVERRIDEABLE_ABILITY = 50,
    SPELL_FAILED_HIGHLEVEL                       = 51,
    SPELL_FAILED_HUNGER_SATIATED                 = 52,
    SPELL_FAILED_IMMUNE                          = 53,
    SPELL_FAILED_INCORRECT_AREA                  = 54,
    SPELL_FAILED_INTERRUPTED                     = 55,
    SPELL_FAILED_INTERRUPTED_COMBAT              = 56,
    SPELL_FAILED_ITEM_ALREADY_ENCHANTED          = 57,
    SPELL_FAILED_ITEM_GONE                       = 58,
    SPELL_FAILED_ITEM_NOT_FOUND                  = 59,
    SPELL_FAILED_ITEM_NOT_READY                  = 60,
    SPELL_FAILED_LEVEL_REQUIREMENT               = 61,
    SPELL_FAILED_LINE_OF_SIGHT                   = 62,
    SPELL_FAILED_LOWLEVEL                        = 63,
    SPELL_FAILED_LOW_CASTLEVEL                   = 64,
    SPELL_FAILED_MAINHAND_EMPTY                  = 65,
    SPELL_FAILED_MOVING                          = 66,
    SPELL_FAILED_NEED_AMMO                       = 67,
    SPELL_FAILED_NEED_AMMO_POUCH                 = 68,
    SPELL_FAILED_NEED_EXOTIC_AMMO                = 69,
    SPELL_FAILED_NEED_MORE_ITEMS                 = 70,
    SPELL_FAILED_NOPATH                          = 71,
    SPELL_FAILED_NOT_BEHIND                      = 72,
    SPELL_FAILED_NOT_FISHABLE                    = 73,
    SPELL_FAILED_NOT_FLYING                      = 74,
    SPELL_FAILED_NOT_HERE                        = 75,
    SPELL_FAILED_NOT_INFRONT                     = 76,
    SPELL_FAILED_NOT_IN_CONTROL                  = 77,
    SPELL_FAILED_NOT_KNOWN                       = 78,
    SPELL_FAILED_NOT_MOUNTED                     = 79,
    SPELL_FAILED_NOT_ON_TAXI                     = 80,
    SPELL_FAILED_NOT_ON_TRANSPORT                = 81,
    SPELL_FAILED_NOT_READY                       = 82,
    SPELL_FAILED_NOT_SHAPESHIFT                  = 83,
    SPELL_FAILED_NOT_STANDING                    = 84,
    SPELL_FAILED_NOT_TRADEABLE                   = 85,
    SPELL_FAILED_NOT_TRADING                     = 86,
    SPELL_FAILED_NOT_UNSHEATHED                  = 87,
    SPELL_FAILED_NOT_WHILE_GHOST                 = 88,
    SPELL_FAILED_NOT_WHILE_LOOTING               = 89,
    SPELL_FAILED_NO_AMMO                         = 90,
    SPELL_FAILED_NO_CHARGES_REMAIN               = 91,
    SPELL_FAILED_NO_CHAMPION                     = 92,
    SPELL_FAILED_NO_COMBO_POINTS                 = 93,
    SPELL_FAILED_NO_DUELING                      = 94,
    SPELL_FAILED_NO_ENDURANCE                    = 95,
    SPELL_FAILED_NO_FISH                         = 96,
    SPELL_FAILED_NO_ITEMS_WHILE_SHAPESHIFTED     = 97,
    SPELL_FAILED_NO_MOUNTS_ALLOWED               = 98,
    SPELL_FAILED_NO_PET                          = 99,
    SPELL_FAILED_NO_POWER                        = 100,
    SPELL_FAILED_NOTHING_TO_DISPEL               = 101,
    SPELL_FAILED_NOTHING_TO_STEAL                = 102,
    SPELL_FAILED_ONLY_ABOVEWATER                 = 103,
    SPELL_FAILED_ONLY_DAYTIME                    = 104,
    SPELL_FAILED_ONLY_INDOORS                    = 105,
    SPELL_FAILED_ONLY_MOUNTED                    = 106,
    SPELL_FAILED_ONLY_NIGHTTIME                  = 107,
    SPELL_FAILED_ONLY_OUTDOORS                   = 108,
    SPELL_FAILED_ONLY_SHAPESHIFT                 = 109,
    SPELL_FAILED_ONLY_STEALTHED                  = 110,
    SPELL_FAILED_ONLY_UNDERWATER                 = 111,
    SPELL_FAILED_OUT_OF_RANGE                    = 112,
    SPELL_FAILED_PACIFIED                        = 113,
    SPELL_FAILED_POSSESSED                       = 114,
    SPELL_FAILED_REAGENTS                        = 115,
    SPELL_FAILED_REQUIRES_AREA                   = 116,
    SPELL_FAILED_REQUIRES_SPELL_FOCUS            = 117,
    SPELL_FAILED_ROOTED                          = 118,
    SPELL_FAILED_SILENCED                        = 119,
    SPELL_FAILED_SPELL_IN_PROGRESS               = 120,
    SPELL_FAILED_SPELL_LEARNED                   = 121,
    SPELL_FAILED_SPELL_UNAVAILABLE               = 122,
    SPELL_FAILED_STUNNED                         = 123,
    SPELL_FAILED_TARGETS_DEAD                    = 124,
    SPELL_FAILED_TARGET_AFFECTING_COMBAT         = 125,
    SPELL_FAILED_TARGET_AURASTATE                = 126,
    SPELL_FAILED_TARGET_DUELING                  = 127,
    SPELL_FAILED_TARGET_ENEMY                    = 128,
    SPELL_FAILED_TARGET_ENRAGED                  = 129,
    SPELL_FAILED_TARGET_FRIENDLY                 = 130,
    SPELL_FAILED_TARGET_IN_COMBAT                = 131,
    SPELL_FAILED_TARGET_IN_PET_BATTLE            = 132,
    SPELL_FAILED_TARGET_IS_PLAYER                = 133,
    SPELL_FAILED_TARGET_IS_PLAYER_CONTROLLED     = 134,
    SPELL_FAILED_TARGET_NOT_DEAD                 = 135,
    SPELL_FAILED_TARGET_NOT_IN_PARTY             = 136,
    SPELL_FAILED_TARGET_NOT_LOOTED               = 137,
    SPELL_FAILED_TARGET_NOT_PLAYER               = 138,
    SPELL_FAILED_TARGET_NO_POCKETS               = 139,
    SPELL_FAILED_TARGET_NO_WEAPONS               = 140,
    SPELL_FAILED_TARGET_NO_RANGED_WEAPONS        = 141,
    SPELL_FAILED_TARGET_UNSKINNABLE              = 142,
    SPELL_FAILED_THIRST_SATIATED                 = 143,
    SPELL_FAILED_TOO_CLOSE                       = 144,
    SPELL_FAILED_TOO_MANY_OF_ITEM                = 145,
    SPELL_FAILED_TOTEM_CATEGORY                  = 146,
    SPELL_FAILED_TOTEMS                          = 147,
    SPELL_FAILED_TRY_AGAIN                       = 148,
    SPELL_FAILED_UNIT_NOT_BEHIND                 = 149,
    SPELL_FAILED_UNIT_NOT_INFRONT                = 150,
    SPELL_FAILED_VISION_OBSCURED                 = 151,
    SPELL_FAILED_WRONG_PET_FOOD                  = 152,
    SPELL_FAILED_NOT_WHILE_FATIGUED              = 153,
    SPELL_FAILED_TARGET_NOT_IN_INSTANCE          = 154,
    SPELL_FAILED_NOT_WHILE_TRADING               = 155,
    SPELL_FAILED_TARGET_NOT_IN_RAID              = 156,
    SPELL_FAILED_TARGET_FREEFORALL               = 157,
    SPELL_FAILED_NO_EDIBLE_CORPSES               = 158,
    SPELL_FAILED_ONLY_BATTLEGROUNDS              = 159,
    SPELL_FAILED_TARGET_NOT_GHOST                = 160,
    SPELL_FAILED_TRANSFORM_UNUSABLE              = 161,
    SPELL_FAILED_WRONG_WEATHER                   = 162,
    SPELL_FAILED_DAMAGE_IMMUNE                   = 163,
    SPELL_FAILED_PREVENTED_BY_MECHANIC           = 164,
    SPELL_FAILED_PLAY_TIME                       = 165,
    SPELL_FAILED_REPUTATION                      = 166,
    SPELL_FAILED_MIN_SKILL                       = 167,
    SPELL_FAILED_NOT_IN_RATED_BATTLEGROUND       = 168,
    SPELL_FAILED_NOT_ON_SHAPESHIFT               = 169,
    SPELL_FAILED_NOT_ON_STEALTHED                = 170,
    SPELL_FAILED_NOT_ON_DAMAGE_IMMUNE            = 171,
    SPELL_FAILED_NOT_ON_MOUNTED                  = 172,
    SPELL_FAILED_TOO_SHALLOW                     = 173,
    SPELL_FAILED_TARGET_NOT_IN_SANCTUARY         = 174,
    SPELL_FAILED_TARGET_IS_TRIVIAL               = 175,
    SPELL_FAILED_BM_OR_INVISGOD                  = 176,
    SPELL_FAILED_GROUND_MOUNT_NOT_ALLOWED        = 177,
    SPELL_FAILED_FLOATING_MOUNT_NOT_ALLOWED      = 178,
    SPELL_FAILED_UNDERWATER_MOUNT_NOT_ALLOWED    = 179,
    SPELL_FAILED_FLYING_MOUNT_NOT_ALLOWED        = 180,
    SPELL_FAILED_APPRENTICE_RIDING_REQUIREMENT   = 181,
    SPELL_FAILED_JOURNEYMAN_RIDING_REQUIREMENT   = 182,
    SPELL_FAILED_EXPERT_RIDING_REQUIREMENT       = 183,
    SPELL_FAILED_ARTISAN_RIDING_REQUIREMENT      = 184,
    SPELL_FAILED_MASTER_RIDING_REQUIREMENT       = 185,
    SPELL_FAILED_COLD_RIDING_REQUIREMENT         = 186,
    SPELL_FAILED_FLIGHT_MASTER_RIDING_REQUIREMENT = 187,
    SPELL_FAILED_CS_RIDING_REQUIREMENT           = 188,
    SPELL_FAILED_PANDA_RIDING_REQUIREMENT        = 189,
    SPELL_FAILED_MOUNT_NO_FLOAT_HERE             = 190,
    SPELL_FAILED_MOUNT_NO_UNDERWATER_HERE        = 191,
    SPELL_FAILED_MOUNT_ABOVE_WATER_HERE          = 192,
    SPELL_FAILED_MOUNT_COLLECTED_ON_OTHER_CHAR   = 193,
    SPELL_FAILED_NOT_IDLE                        = 194,
    SPELL_FAILED_NOT_INACTIVE                    = 195,
    SPELL_FAILED_PARTIAL_PLAYTIME                = 196,
    SPELL_FAILED_NO_PLAYTIME                     = 197,
    SPELL_FAILED_NOT_IN_BATTLEGROUND             = 198,
    SPELL_FAILED_NOT_IN_RAID_INSTANCE            = 199,
    SPELL_FAILED_ONLY_IN_ARENA                   = 200,
    SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE  = 201,
    SPELL_FAILED_ON_USE_ENCHANT                  = 202,
    SPELL_FAILED_NOT_ON_GROUND                   = 203,
    SPELL_FAILED_CUSTOM_ERROR                    = 204,
    SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW          = 205,
    SPELL_FAILED_TOO_MANY_SOCKETS                = 206,
    SPELL_FAILED_INVALID_GLYPH                   = 207,
    SPELL_FAILED_UNIQUE_GLYPH                    = 208,
    SPELL_FAILED_GLYPH_SOCKET_LOCKED             = 209,
    SPELL_FAILED_GLYPH_EXCLUSIVE_CATEGORY        = 210,
    SPELL_FAILED_GLYPH_INVALID_SPEC              = 211,
    SPELL_FAILED_GLYPH_NO_SPEC                   = 212,
    SPELL_FAILED_NO_VALID_TARGETS                = 213,
    SPELL_FAILED_ITEM_AT_MAX_CHARGES             = 214,
    SPELL_FAILED_NOT_IN_BARBERSHOP               = 215,
    SPELL_FAILED_FISHING_TOO_LOW                 = 216,
    SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW       = 217,
    SPELL_FAILED_SUMMON_PENDING                  = 218,
    SPELL_FAILED_MAX_SOCKETS                     = 219,
    SPELL_FAILED_PET_CAN_RENAME                  = 220,
    SPELL_FAILED_TARGET_CANNOT_BE_RESURRECTED    = 221,
    SPELL_FAILED_TARGET_HAS_RESURRECT_PENDING    = 222,
    SPELL_FAILED_NO_ACTIONS                      = 223,
    SPELL_FAILED_CURRENCY_WEIGHT_MISMATCH        = 224,
    SPELL_FAILED_WEIGHT_NOT_ENOUGH               = 225,
    SPELL_FAILED_WEIGHT_TOO_MUCH                 = 226,
    SPELL_FAILED_NO_VACANT_SEAT                  = 227,
    SPELL_FAILED_NO_LIQUID                       = 228,
    SPELL_FAILED_ONLY_NOT_SWIMMING               = 229,
    SPELL_FAILED_BY_NOT_MOVING                   = 230,
    SPELL_FAILED_IN_COMBAT_RES_LIMIT_REACHED     = 231,
    SPELL_FAILED_NOT_IN_ARENA                    = 232,
    SPELL_FAILED_TARGET_NOT_GROUNDED             = 233,
    SPELL_FAILED_EXCEEDED_WEEKLY_USAGE           = 234,
    SPELL_FAILED_NOT_IN_LFG_DUNGEON              = 235,
    SPELL_FAILED_BAD_TARGET_FILTER               = 236,
    SPELL_FAILED_NOT_ENOUGH_TARGETS              = 237,
    SPELL_FAILED_NO_SPEC                         = 238,
    SPELL_FAILED_CANT_ADD_BATTLE_PET             = 239,
    SPELL_FAILED_CANT_UPGRADE_BATTLE_PET         = 240,
    SPELL_FAILED_WRONG_BATTLE_PET_TYPE           = 241,
    SPELL_FAILED_NO_DUNGEON_ENCOUNTER            = 242,
    SPELL_FAILED_NO_TELEPORT_FROM_DUNGEON        = 243,
    SPELL_FAILED_MAX_LEVEL_TOO_LOW               = 244,
    SPELL_FAILED_CANT_REPLACE_ITEM_BONUS         = 245,
    GRANT_PET_LEVEL_FAIL                         = 246,
    SPELL_FAILED_SKILL_LINE_NOT_KNOWN            = 247,
    SPELL_FAILED_BLUEPRINT_KNOWN                 = 248,
    SPELL_FAILED_FOLLOWER_KNOWN                  = 249,
    SPELL_FAILED_CANT_OVERRIDE_ENCHANT_VISUAL    = 250,
    SPELL_FAILED_ITEM_NOT_A_WEAPON               = 251,
    SPELL_FAILED_SAME_ENCHANT_VISUAL             = 252,
    SPELL_FAILED_TOY_USE_LIMIT_REACHED           = 253,
    SPELL_FAILED_SHIPMENTS_FULL                  = 254,
    SPELL_FAILED_HAS_MISSION                     = 255,
    SPELL_FAILED_BUILDING_ACTIVATE_NOT_READY     = 256,
    SPELL_FAILED_NOT_SOULBOUND                   = 257,
    SPELL_FAILED_UNKNOWN                         = 258, // custom value, default case
    SPELL_CAST_OK,                                      // custom value, must not be sent to client
};
...
enum ChatMsg
{
    ...
    CHAT_MSG_EMOTE                  = 0x09,
    CHAT_MSG_TEXT_EMOTE             = 0x0A,
    CHAT_MSG_MONSTER_SAY            = 0x0B,
    CHAT_MSG_MONSTER_PARTY          = 0x0C,
    CHAT_MSG_MONSTER_YELL           = 0x0D,
    CHAT_MSG_MONSTER_WHISPER        = 0x0E,
    CHAT_MSG_MONSTER_EMOTE          = 0x0F,
    CHAT_MSG_CHANNEL                = 0x10,
    CHAT_MSG_CHANNEL_JOIN           = 0x11,
    CHAT_MSG_CHANNEL_LEAVE          = 0x12,
    CHAT_MSG_CHANNEL_LIST           = 0x13,
    CHAT_MSG_CHANNEL_NOTICE         = 0x14,
    CHAT_MSG_CHANNEL_NOTICE_USER    = 0x15,
    CHAT_MSG_AFK                    = 0x16,
    CHAT_MSG_DND                    = 0x17,
    CHAT_MSG_IGNORED                = 0x18,
    CHAT_MSG_SKILL                  = 0x19,
    CHAT_MSG_LOOT                   = 0x1A,
    CHAT_MSG_CURRENCY               = 0x1B,
    CHAT_MSG_MONEY                  = 0x1C,
    ...
    CHAT_MSG_ACHIEVEMENT            = 0x2D,
    CHAT_MSG_GUILD_ACHIEVEMENT      = 0x2E,
    CHAT_MSG_PET_BATTLE_COMBAT_LOG  = 0x2F,
    CHAT_MSG_PET_BATTLE_INFO        = 0x30,
    CHAT_MSG_INSTANCE_CHAT          = 0x31,
    CHAT_MSG_INSTANCE_CHAT_LEADER   = 0x32,
    ...
    CHAT_MSG_COMBAT_GUILD_XP_GAIN   = 0x3F, // still exist ?
};
...
enum DungeonStatusFlag
{
    ...
    DUNGEON_STATUSFLAG_EVENT     = 0x04,
    DUNGEON_STATUSFLAG_CHALLENGE = 0x08,

    RAID_STATUSFLAG_10MAN_NORMAL = 0x001,
    RAID_STATUSFLAG_25MAN_NORMAL = 0x002,
    RAID_STATUSFLAG_10MAN_HEROIC = 0x004,
    RAID_STATUSFLAG_25MAN_HEROIC = 0x008,
    RAID_STATUSFLAG_NORMAL       = 0x010,
    RAID_STATUSFLAG_HEROIC       = 0x020,
    RAID_STATUSFLAG_MYTHIC       = 0x040,
    RAID_STATUSFLAG_LFR          = 0x080,
    RAID_STATUSFLAG_40MAN        = 0x100,
    RAID_STATUSFLAG_RAID_FINDER  = 0x200,
    RAID_STATUSFLAG_EVENT        = 0x400,
    
    SCENARIO_STATUSFLAG_NORMAL   = 0x01,
    SCENARIO_STATUSFLAG_HEROIC   = 0x02,
    SCEANRIO_STATUSFLAG_EVENT    = 0x04
};

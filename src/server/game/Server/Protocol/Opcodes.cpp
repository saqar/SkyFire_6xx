...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                                  0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_BATTLEGROUND,                            0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_OFFICER,                                 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID,                                    0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,                            0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                                 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LEAVE_CHANNEL,                                       0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLeaveChannel                 ); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY,                    0x063D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankMoneyWithdrawn      ); // 6.0.3 19116
    ...
    ///< Battle Pay
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,                         0x1389, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        ); // 6.0.3 19116
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SEND_UNLEARN_SPELLS,                             0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_PROFICIENCY,                                 0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                              0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                                   0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_SERVER_INFO,                               0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_TIME_RESPONSE,                             0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE,            0x12A4, STATUS_UNHANDLED); // 6.0.3 19116

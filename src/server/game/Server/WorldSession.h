...
class WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleCharUndeleteOpcode(WorldPacket& recvPacket);
        void HandleCharUndeleteCooldownOpcode(WorldPacket& recvPacket);
        ...
        void HandleWorldportrResponse(WorldPacket& recvPacket);
        ...
        void HandeLearnPetSpecializationGroup(WorldPacket& recvPacket);
        ...
        // Battlefield
        void SendBfInvitePlayerToWar(uint64 QueueID, uint32 AreaID, uint32 Time);

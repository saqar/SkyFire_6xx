...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ACTIVATETAXI,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_ACTIVATETAXIEXPRESS,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiExpressOpcode    );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ADD_FRIEND,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddFriendOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_ADD_IGNORE,                         0x1321, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddIgnoreOpcode              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_ADD_VOICE_IGNORE,                   0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_ALTER_APPEARANCE,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAlterAppearance              );
    DEFINE_OPCODE_HANDLER(CMSG_AREATRIGGER,                        0x01B4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAreaTriggerOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ATTACKSTOP,                         0x065B, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackStopOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_ATTACKSWING,                        0x1E9B, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackSwingOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_HELLO,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_LIST_BIDDER_ITEMS,          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListBidderItems       );
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_LIST_ITEMS,                 0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListItems             );
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_LIST_OWNER_ITEMS,           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListOwnerItems        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_PLACE_BID,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionPlaceBid              );
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_REMOVE_ITEM,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionRemoveItem            );
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_SELL_ITEM,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionSellItem              );
    DEFINE_OPCODE_HANDLER(CMSG_AUTH_SESSION,                       0x0487, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_AUTOBANK_ITEM,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoBankItemOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM,                     0x0F35, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemOpcode          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BAG_ITEM,                 0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoStoreBagItemOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BANK_ITEM,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoStoreBankItemOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BANKER_ACTIVATE,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBankerActivateOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_LEAVE,                  0x06F1, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlefieldLeaveOpcode       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_LIST,                   0x03B1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldListOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE, 0x059A, STATUS_LOGGEDIN, PROCESS_INPLACE,    &WorldSession::HandleBfEntryInviteResponse        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_EXIT_REQUEST,       0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBfExitRequest                );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE, 0x0000, STATUS_LOGGEDIN, PROCESS_INPLACE,    &WorldSession::HandleBfQueueInviteResponse        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_PORT,                   0x11EB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattleFieldPortOpcode        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN,                  0x0D2E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinOpcode       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN_ARENA,            0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinArena        );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN_RATED,            0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,        0x1389, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_SELECT_CHOICE, 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_DELETE_PET,              0x07B9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetDelete              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_MODIFY_NAME,             0x03A9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetModifyName          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_QUERY_NAME,              0x041C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetQueryName           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_BATTLE_SLOT,         0x120B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSetBattleSlot       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SET_FLAGS,               0x0BA2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSetFlags            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SUMMON_COMPANION,        0x0B38, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetSummonCompanion     ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BLACKMARKET_BID,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketBidOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_BLACKMARKET_HELLO,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketHelloOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_BLACKMARKET_REQUEST_ITEMS,          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketRequestItemOpcode );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUYBACK_ITEM,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuybackItem                  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUY_ITEM,                           0x0352, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyItemOpcode                ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_AURA,                        0x08AE, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAuraOpcode             ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_CAST,                        0x0071, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCancelCastOpcode             ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_MOUNT_AURA,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelMountAuraOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_TRADE,                       0x1159, STATUS_LOGGEDIN_OR_RECENTLY_LOGGOUT, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelTradeOpcode); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_CAST_SPELL,                         0x08FE, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCastSpellOpcode              ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CREATE,                        0x070D, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCreateOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCustomize                );
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_DELETE,                        0x030E, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharDeleteOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_ENUM,                          0x0918, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode               ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_UNDELETE,                      0x0D99, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCharUndeleteOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_UNDELETE_COOLDOWN,             0x19A9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCharUndeleteCooldownOpcode   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CONTACT_LIST,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleContactListOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CREATURE_QUERY,                     0x0505, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleCreatureQueryOpcode          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_DANCE_QUERY,                        0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_DB_QUERY_BULK,                      0x138B, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleDBQueryBulk                  ); // 6.0.3 19103             
    DEFINE_OPCODE_HANDLER(CMSG_DEL_FRIEND,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDelFriendOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_DEL_IGNORE,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDelIgnoreOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_DEL_VOICE_IGNORE,                   0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_DESTROY_ITEM,                       0x01EE, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDestroyItemOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DUEL_PROPOSED,                      0x0B25, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelProposedOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_DUEL_RESPONSE,                      0x1BD2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelResponseOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_EJECT_PASSENGER,                    0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_EMOTE,                              0x0A27, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEmoteOpcode                  ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_ENABLETAXI,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiQueryAvailableNodes      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJECT_QUERY,                   0x03AE, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectQueryOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJ_REPORT_USE,                 0x082E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGameobjectReportUse          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_HELLO,                       0x00F3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipHelloOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_SELECT_OPTION,               0x0332, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipSelectOptionOpcode     ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GRANT_LEVEL,                        0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGrantLevel                   );
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_ASSISTANT_LEADER,             0x0B26, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupAssistantLeaderOpcode   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_DISBAND,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupDisbandOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_INVITE,                       0x122C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInviteOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_INVITE_RESPONSE,              0x118A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInviteResponseOpcode    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_RAID_CONVERT,                 0x0137, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupRaidConvertOpcode       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_REQUEST_JOIN_UPDATES,         0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_SET_LEADER,                   0x091E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupSetLeaderOpcode         ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_SET_ROLES,                    0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGroupSetRolesOpcode          );
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_SWAP_SUB_GROUP,               0x0BA4, STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::HandleGroupSwapSubGroupOpcode      ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_UNINVITE_GUID,                0x1982, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteGuidOpcode      ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ACCEPT,                       0x0B20, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAcceptOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ACHIEVEMENT_MEMBERS,          0x0C40, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ADD_RANK,                     0x1630, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAddRankOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ASSIGN_MEMBER_RANK,           0x0436, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAssignRankOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANKER_ACTIVATE,              0x19E3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankerActivate          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_BUY_TAB,                 0x1BC3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankBuyTab              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_DEPOSIT_MONEY,           0x1B11, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankDepositMoney        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_LOG_QUERY,               0x0428, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankLogQuery            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY,   0x063D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankMoneyWithdrawn      ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_QUERY_TAB,               0x1139, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankQueryTab            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_QUERY_TEXT,              0x062D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleQueryGuildBankTabText        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_SWAP_ITEMS,              0x1131, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankSwapItems           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_UPDATE_TAB,              0x13C1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankUpdateTab           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_WITHDRAW_MONEY,          0x020D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankWithdrawMoney       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_CHANGE_NAME_REQUEST,          0x043E, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DECLINE,                      0x0476, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDeclineOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DEL_RANK,                     0x0C28, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDelRankOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DEMOTE,                       0x142F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDemoteOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DISBAND,                      0x0E68, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDisbandOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_EVENT_LOG_QUERY,              0x065A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildEventLogQueryOpcode     ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_INFO_TEXT,                    0x0C75, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildChangeInfoTextOpcode    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_INVITE,                       0x19A4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInviteOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_LEAVE,                        0x0667, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaveOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_MEMBER_SEND_SOR_REQUEST,      0x0666, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_MOTD,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildMOTDOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_NEWS_UPDATE_STICKY,           0x1625, STATUS_LOGGEDIN , PROCESS_INPLACE,      &WorldSession::HandleGuildNewsUpdateStickyOpcode  ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_PROMOTE,                      0x1467, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildPromoteOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY,                        0x0930, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_NEWS,                   0x0676, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGuildQueryNewsOpcode         ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_RANKS,                  0x0C37, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryRanksOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_REMOVE,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRemoveOpcode            );
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_REPLACE_GUILD_MASTER,         0x163E, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_REQUEST_CHALLENGE_UPDATE,     0x043F, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleGuildRequestChallengeUpdate  ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ROSTER,                       0x0638, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRosterOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_GUILD_MASTER,             0x0C2F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetGuildMaster          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_RANK_PERMISSIONS,         0x0E38, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetRankPermissionsOpcode); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SWITCH_RANK,                  0x0627, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_INSPECT,                            0x01EC, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectOpcode                ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_JOIN_CHANNEL,                       0x0B4B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannel                  ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_LFG_LIST_BLACKLIST,         0x149B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SET_LFG_FAST_LAUNCH,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SET_TIME_WALKER_DUNGEON,            0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_GET_STATUS,                     0x1BA4, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleLfgGetStatus                 ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_JOIN,                           0x0925, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgJoinOpcode                ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_LEAVE,                          0x01A2, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgLeaveOpcode               ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_PROPOSAL_RESULT,                0x0509, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgProposalResultOpcode      ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_BOOT_VOTE,                  0x0308, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetBootVoteOpcode         ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_COMMENT,                    0x0B89, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_ROLES,                      0x1B82, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetRolesOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LFG_TELEPORT,                       0x0316, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LIST_INVENTORY,                     0x0B39, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListInventoryOpcode          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOAD_SCREEN,                        0x0B08, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleLoadScreenOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_CANCEL,                      0x03C2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutCancelOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_REQUEST,                     0x1911, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutRequestOpcode          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOG_DISCONNECT,                     0x04D5, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOOT,                               0x01B1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode                   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_METHOD,                        0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMethodOpcode             );
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_MONEY,                         0x1991, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMoneyOpcode              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_RELEASE,                       0x1199, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootReleaseOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_AFK,                    0x1BDC, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_BATTLEGROUND,           0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_CHANNEL,                0x0913, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_DND,                    0x0AAB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_EMOTE,                  0x113C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_GUILD,                  0x0B1B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_OFFICER,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_PARTY,                  0x0134, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_SAY,                    0x1884, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_YELL,                   0x1161, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                         0x0B15, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleRealmNameQueryOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NPC_TEXT_QUERY,                     0x0ECB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNpcTextQueryOpcode           ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OFFER_PETITION,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOfferPetitionOpcode          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_ITEM,                          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOpenItemOpcode               );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_BUY,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionBuyOpcode            );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_DECLINE,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_RENAME,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_QUERY,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionQueryOpcode          );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_SHOWLIST,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionShowListOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_SHOW_SIGNATURES,           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionShowSignOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_PETITION_SIGN,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionSignOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_PET_ABANDON,                        0x0005, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetAbandon                   ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_ACTION,                         0x133A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetAction                    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_CANCEL_AURA,                    0x0A30, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetCancelAuraOpcode          ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_CAST_SPELL,                     0x0286, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetCastSpellOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_LEARN_TALENT,                   0x08D6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetLearnTalent               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_QUERY,                     0x048B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetNameQuery                 ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_RENAME,                         0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetRename                    );
    DEFINE_OPCODE_HANDLER(CMSG_PET_SET_ACTION,                     0x020F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSetAction                 ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_SPELL_AUTOCAST,                 0x0A2F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSpellAutocastOpcode       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PET_STOP_ATTACK,                    0x19E2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetStopAttack                ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PING,                               0x0416, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                        0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                   );
    DEFINE_OPCODE_HANDLER(CMSG_PLAYER_LOGIN,                       0x0B1D, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLoginOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PVP_LOG_DATA,                       0x08B5, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePVPLogDataOpcode             ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_REWARDS,                0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGuildRewardsQueryOpcode      );
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_XP,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryXPOpcode           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_ACCEPT_QUEST,            0x13D3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverAcceptQuestOpcode  ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CHOOSE_REWARD,           0x0DAD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverChooseRewardOpcode ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_COMPLETE_QUEST,          0x1E8A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCompleteQuest      ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_HELLO,                   0x058E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverHelloOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUERY_QUEST,             0x1924, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQueryQuestOpcode   ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_REQUEST_REWARD,          0x022E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverRequestRewardOpcode); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,   0x0131, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_QUERY,            0x01E2, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverStatusQueryOpcode  ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_REMOVE_QUEST,              0x0139, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogRemoveQuest          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_POI_QUERY,                    0x0B81, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPOIQuery                ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_QUERY,                        0x09A6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestQueryOpcode             ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_RANDOM_ROLL,                        0x12AA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_RANDOMIZE_CHAR_NAME,                0x1981, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRandomizeCharNameOpcode      ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_READ_ITEM,                          0x08F6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReadItem                     ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REPAIR_ITEM,                        0x0B54, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepairItemOpcode             ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                     0x09AC, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix                ); // 6.0.2 18833
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PVP_OPTIONS_ENABLED,        0x120C, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestPvpOptions            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PVP_REWARDS,                0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestPvpReward             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SELL_ITEM,                          0x0351, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSellItemOpcode               ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SETSHEATHED,                        0x1B43, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSheathedOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTION_BUTTON,                  0x0599, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionButtonOpcode        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_CONTACT_NOTES,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetContactNotesOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_SET_CURRENCY_FLAGS,                 0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_SET_DUNGEON_DIFFICULTY,             0x012F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode   ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PRIMARY_TALENT_TREE,            0x0AC5, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandeSetTalentSpecialization       ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SET_PVP,                            0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetPvP                       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_SELECTION,                      0x05BD, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SET_TAXI_BENCHMARK_MODE,            0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTaxiBenchmarkOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SOCKET_GEMS,                        0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSocketOpcode                 );
    DEFINE_OPCODE_HANDLER(CMSG_SORT_BAGS,                          0x1399, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSortBagsOpcode               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SORT_BANK_BAGS,                     0x13BB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSortBankBagsOpcode           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SPELLCLICK,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSpellClick                   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SPLIT_ITEM,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSplitItemOpcode              );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_INV_ITEM,                      0x04ED, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSwapInvItemOpcode            ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_ITEM,                          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSwapItem                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TEXT_EMOTE,                         0x0518, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTextEmoteOpcode              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_TIME_ADJUSTMENT_RESPONSE,           0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESP,                     0x0003, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTimeSyncResp                 ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESP_FAILED,              0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_PVP,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTogglePvP                    );
    DEFINE_OPCODE_HANDLER(CMSG_TOTEM_DESTROYED,                    0x000D, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTotemDestroyed               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_TRAINER_BUY_SPELL,                  0x0A28, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTrainerBuySpellOpcode        ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_TRAINER_LIST,                       0x0A2E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTrainerListOpcode            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SKILL,                      0x0A26, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnlearnSkillOpcode           ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_ACCOUNT_DATA,                0x12A1, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateAccountData            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_USE_ITEM,                           0x08B6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUseItemOpcode                ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_VIOLENCE_LEVEL,                     0x0000, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleViolenceLevel                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_VOID_STORAGE_QUERY,                 0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageQuery             );
    DEFINE_OPCODE_HANDLER(CMSG_VOID_STORAGE_TRANSFER,              0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageTransfer          );
    DEFINE_OPCODE_HANDLER(CMSG_VOID_STORAGE_UNLOCK,                0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageUnlock            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x0302, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleWorldStateUITimerUpdate      ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                 0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode      );
    ...
    ///< Garrison & Shipment
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_ALL_READY_SHIPMENTS,       0x0AE6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteAllReadyShipment     ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_SHIPMENT,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteShipment             );
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_SHIPMENT_CHEAT,            0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CREATE_SHIPMENT,                    0x06E3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCreateShipment               ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_CREATE_SHIPMENT_CHEAT,              0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_GET_SHIPMENT_INFO,                  0x068B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetShipmentInfo              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GET_SHIPMENTS_OF_TYPE,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetShipmentOfType            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_SHIPMENT_NPC,                  0x03D9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOpenShipmentNpc              ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING,   0x095A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrAssignFollower           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GARR_COMPLETE_MISSION,              0x02C2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrCompleteMission          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_GENERATE_RECRUITS,             0x0472, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrGenerateRecruits         ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_MISSION_BONUS_ROLL,            0x102C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrMissionBonusRoll         ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_PURCHASE_BUILDING,             0x04A2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrPurchaseBuilding         ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GARR_RECRUIT_FOLLOWER,              0x028E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRecruitFollower          ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING, 0x01BB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRemoveFollower           ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA, 0x16F2, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRequestBlueprintData); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_SET_BUILDING_ACTIVE,           0x041A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrSetBuildingActive        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_START_MISSION,                 0x1624, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrStartMission             ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GARR_SWAP_BUILDING,                 0x09BD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrSwapBuildings            ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GET_GARR_INFO,                      0x0623, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrGetInfo                  ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_UPGRADE_GARR,                       0x0526, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGarrUpgrade                  ); // 6.0.3 19103
    
    ///< Movement
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TIME_SKIPPED,                  0x19C2, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMoveTimeSkippedOpcode        ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_CHARM_TELEPORT_CHEAT,          0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_FALL_LAND,                     0x0D54, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_HEARTBEAT,                     0x19C1, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_HOVER_ACK,                     0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleMoveHoverAck                 );
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_JUMP,                          0x0282, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_FACING,                    0x19D2, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_PITCH,                     0x0D92, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_RUN_MODE,                  0x0D51, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_WALK_MODE,                 0x0544, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_ASCEND,                  0x0D41, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_BACKWARD,                0x0583, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_DESCEND,                 0x0B79, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_FORWARD,                 0x0521, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_PITCH_DOWN,              0x0151, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_PITCH_UP,                0x1974, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_STRAFE_LEFT,             0x0082, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_STRAFE_RIGHT,            0x1151, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_SWIM,                    0x0B7A, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_TURN_LEFT,               0x0D14, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_TURN_RIGHT,              0x0964, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP,                          0x0513, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_ASCEND,                   0x197C, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_PITCH,                    0x0503, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_STRAFE,                   0x01D1, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_SWIM,                     0x097C, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_TURN,                     0x000B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TELEPORT_ACK,                  0x0D01, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TELEPORT_CHEAT,                0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TIME_SKIPPED,                  0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TOGGLE_COLLISION_CHEAT,        0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WORLDPORT_RESPONSE,                 0x0938, STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleWorldportrResponse           ); // 6.0.3 19103
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACCOUNT_DATA_TIMES,                 0x0120, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACHIEVEMENT_DELETED,                0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_ACHIEVEMENT_EARNED,                 0x010E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_ACTION_BUTTONS,                     0x1D1F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_ACTIVATETAXIREPLY,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_ADDON_INFO,                         0x1D9F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_ADD_RUNE_POWER,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_AI_REACTION,                        0x0BA1, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKERSTATEUPDATE,                0x1204, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTART,                        0x1D3E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTOP,                         0x1382, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_BIDDER_LIST_RESULT,         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_BIDDER_NOTIFICATION,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_COMMAND_RESULT,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_HELLO,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_LIST_PENDING_SALES,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_LIST_RESULT,                0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_OWNER_LIST_RESULT,          0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_OWNER_NOTIFICATION,         0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AURA_UPDATE,                        0x091C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                     0x1759, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                      0x0DA9, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BARBER_SHOP_RESULT,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_LIST,                   0x11A1, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECTED,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECT_PENDING,      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTERED,            0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS,                 0x1E89, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_QUEUED,          0x002D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_ACTIVE,          0x1284, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION, 0x1719, STATUS_NEVER   ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS,   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_FAILED,          0x0308, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_INFO_THROTTLED,        0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_PLAYER_JOINED,         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_PLAYER_LEFT,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE, 0x12A4, STATUS_UNHANDLED); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DELETED,                 0x0138, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL,                 0x19A2, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED,   0x0000, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_DENINED,    0x1BEC, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUERY_NAME_RESPONSE,     0x09EC, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_SLOT_UPDATE,             0x0000, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UPDATE,                  0x0354, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BINDER_CONFIRM,                     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BINDPOINTUPDATE,                    0x0A30, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_HELLO,                  0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BUY_FAILED,                         0x013A, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_BUY_ITEM,                           0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CANCEL_COMBAT,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CAST_FAILED,                        0x1A89, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHANNEL_START,                      0x016C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CHANNEL_UPDATE,                     0x19DB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_LOGIN_FAILED,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CREATE,                        0x0107, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_DELETE,                        0x0BC4, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                          0x05AF, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_UNDELETE_RESPONSE,             0x0344, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_UNDELETE_COOLDOWN_RESPONSE,    0x0310, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_COMPLETE,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REWARDS,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_ALL_MAP_STATS,       0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE,    0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SET_ITEM_CHALLENGE_MODE_DATA,       0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_ITEM_CHALLENGE_MODE_DATA,     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_DUMP_LEADERS_RESULT, 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_DELETE_LEADER_RESULT,0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_BOSS_EMOTES,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWN,                     0x0226, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWNS,                    0x0BFA, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                0x080D, STATUS_NEVER    );  // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CONTACT_LIST,                       0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CREATURE_QUERY_RESPONSE,            0x0A26, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CRITERIA_DELETED,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE,                    0x0912, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DB_REPLY,                           0x1939, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DEFENSE_MESSAGE,                    0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_DESTROY_OBJECT,                     0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COMPLETE,                      0x14C9, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COUNTDOWN,                     0x020E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_INBOUNDS,                      0x03E4, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_OUTOFBOUNDS,                   0x0111, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_REQUESTED,                     0x0827, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_WINNER,                        0x0935, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ENABLE_BARBER_SHOP,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_ENCHANTMENTLOG,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_ENVIRONMENTALDAMAGELOG,             0x0AAB, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_FEATURE_SYSTEM_STATUS,              0x0B1E, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_FRIEND_STATUS,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_CUSTOM_ANIM,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_DESPAWN_ANIM,            0x0D29, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_PAGETEXT,                0x1B19, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_QUERY_RESPONSE,          0x128A, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_COMPLETE,                    0x15D1, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_MESSAGE,                     0x1746, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_POI,                         0x011E, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DECLINE,                      0x153F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DESTROYED,                    0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_INVITE,                       0x0920, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_LIST,                         0x00AC, STATUS_NEVER    ); // 6.0.2 18833 -- Cant find
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_SET_LEADER,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_SET_ROLE,                     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_UNINVITE,                     0x0110, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DATA,             0x1866, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DELETED,          0x1058, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_EARNED,           0x1048, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_MEMBERS,          0x1826, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_LIST,                    0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_LOG_QUERY_RESULT,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_MONEY_WITHDRAWN,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_QUERY_TEXT_RESULT,       0x1875, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_CHALLENGE_COMPLETED,          0x1836, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_CHALLENGE_UPDATED,            0x1A06, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_CHANGE_NAME_RESULT,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT,               0x1205, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT_2,             0x0000, STATUS_UNHANDLED); 
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DATA,                0x1208, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DELETED,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_DECLINE,                      0x1226, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT,                        0x1027, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_LOG_QUERY_RESULT,       0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_FLAGGED_FOR_RENAME,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE,                       0x1025, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE_CANCEL,                0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_MEMBER_DAILY_RESET,           0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_QUERY_RESPONSE,               0x1046, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_RECIPES,                      0x1078, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_RENAMED,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_REPUTATION_REACTION_CHANGED,  0x1068, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_REPUTATION_WEEKLY_CAP,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_RESET,                        0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_REWARDS_LIST,                 0x1818, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ROSTER,                       0x1026, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_UPDATE_ROSTER,                0x1265, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_XP,                           0x0B07, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_XP_GAIN,                      0x0000, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_HEALTH_UPDATE,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_HIGHEST_THREAT_UPDATE,              0x059A, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_HOTFIX_INFO,                        0x1D1D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_HOTFIX_NOTIFY,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_INITIALIZE_FACTIONS,                0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_INITIAL_SPELLS,                     0x0A81, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_INIT_WORLD_STATES,                  0x0B04, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_INSPECT,                            0x052E, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INSTANCE_RESET,                     0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INVENTORY_CHANGE_FAILURE,           0x0112, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                   0x0183, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ITEM_TIME_UPDATE,                   0x0F3E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LEARNED_DANCE_MOVES,                0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                      0x08AB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LEVELUP_INFO,                       0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SET_LFG_TIME_WALKER,                0x0731, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SET_LFG_FAST_LAUNCH_RESULT,         0x0F52, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_LIST_JOIN_RESULT,               0x0793, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_LIST_UPDATE_STATUS,             0x0F18, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_LIST_UPDATE_BLACKLIST,          0x0754, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_BOOT_PROPOSAL_UPDATE,           0x07B3, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_DISABLED,                       0x0714, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_JOIN_RESULT,                    0x0F72, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_OFFER_CONTINUE,                 0x0797, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PARTY_INFO,                     0x0F92, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PLAYER_INFO,                    0x0F36, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PLAYER_REWARD,                  0x0F15, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PROPOSAL_UPDATE,                0x0F32, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_QUEUE_STATUS,                   0x07F1, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_ROLE_CHECK_UPDATE,              0x0736, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_ROLE_CHOSEN,                    0x07D3, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_SLOT_INVALID,                   0x07B1, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_TELEPORT_DENIED,                0x0795, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LFG_UPDATE_SEARCH,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LFG_UPDATE_STATUS,                  0x07F7, STATUS_UNHANDLED); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LIST_INVENTORY,                     0x0940, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOAD_CUF_PROFILES,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_SETTIMESPEED,                 0x09AA, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_VERIFY_WORLD,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_CANCEL_ACK,                  0x0FAD, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_COMPLETE,                    0x0B21, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_RESPONSE,                    0x052D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOG_XPGAIN,                         0x1B53, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_AE_TARGET_ACK,                 0x031D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_AE_TARGETS,                    0x15AF, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CLEAR_MONEY,                   0x19AC, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_LIST,                          0x03A4, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MASTER_LIST,                   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MONEY_NOTIFY,                  0x12A9, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RELEASE_RESPONSE,              0x0BD3, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_REMOVED,                       0x0906, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RESPONSE,                      0x0F8A, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MESSAGECHAT,                        0x0603, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOTD,                               0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTRESULT,                        0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTSPECIAL_ANIM,                  0x159F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_MULTIPLE_PACKETS,                   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_NAME_QUERY_RESPONSE,                0x0828, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_REALM_NAME_QUERY_RESPONSE,          0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_NEW_TAXI_PATH,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                          0x0206, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD_ABORT,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_NOTIFICATION,                       0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NPC_TEXT_UPDATE,                    0x1122, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_LFG_DUNGEON_FINDER,            0x0F17, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PARTYKILLLOG,                       0x1312, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PARTY_COMMAND_RESULT,               0x0B44, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PERIODICAURALOG,                    0x0B1B, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PETGODMODE,                         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_ALREADY_SIGNED,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_QUERY_RESPONSE,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_RENAME_RESULT,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_SHOWLIST,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_SHOW_SIGNATURES,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PETITION_SIGN_RESULTS,              0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_PET_ACTION_FEEDBACK,                0x0D9E, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_ACTION_SOUND,                   0x0D39, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_ADDED,                          0x0327, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_BROKEN,                         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PET_CAST_FAILED,                    0x1914, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_DISMISS_SOUND,                  0x09A3, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_GUIDS,                          0x150F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_LEARNED_SPELL,                  0x1822, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_MODE,                           0x1D40, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_NAME_INVALID,                   0x0007, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_NAME_QUERY_RESPONSE,            0x0D0E, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_SLOT_UPDATED,                   0x0B26, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_SPELLS,                         0x0174, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                   0x0025, STATUS_UNHANDLED); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYERBOUND,                        0x078E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                        0x0ACE, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAY_OBJECT_SOUND,                  0x1C8A, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PLAY_ONE_SHOT_ANIM_KIT,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PLAY_SOUND,                         0x02D2, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PONG,                               0x17CA, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_POWER_UPDATE,                       0x0B27, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PVP_LOG_DATA,                       0x1ECA, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PVP_OPTIONS_ENABLED,                0x0320, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_PVP_SEASON,                         0x09E3, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_QUESTS_COMPLETED_RESPONSE,    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_TIME_RESPONSE,                0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_OFFER_REWARD,            0x17B2, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_COMPLETE,          0x1773, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_DETAILS,           0x15B3, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_LIST,              0x17A5, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_REQUEST_ITEMS,           0x17B8, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS,                  0x1567, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS_MULTIPLE,         0x17C6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTLOG_FULL,                      0x17E4, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_CREDIT,             0x1515, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_PVP_KILL,           0x15A6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_COMPLETE,               0x1787, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_FAILED,                 0x1542, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_FAILEDTIMER,            0x1D01, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_CONFIRM_ACCEPT,               0x15B2, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_POI_QUERY_RESPONSE,           0x1715, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_QUERY_RESPONSE,               0x1547, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RAID_READY_CHECK_COMPLETED,         0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RANDOMIZE_CHAR_NAME,                0x0BAA, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REAL_GROUP_UPDATE,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_RECEIVED_MAIL,                      0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REMOVED_SPELL,                      0x0BCB, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REQUEST_PVP_REWARDS_RESPONSE,       0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_STATE,                     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_PROGRESS_UPDATE,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_POIS,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_BOOT,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_OUT_OF_BOUNDS,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SELL_ITEM,                          0x1352, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SEND_MAIL_RESULT,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SEND_UNLEARN_SPELLS,                0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SERVER_MESSAGE,                     0x0683, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_DUNGEON_DIFFICULTY,             0x0719, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_FLAT_SPELL_MODIFIER,            0x1884, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SET_FORCED_REACTIONS,               0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SET_PCT_SPELL_MODIFIER,             0x113C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SET_PHASE_SHIFT,                    0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SET_TIMEZONE_INFORMATION,           0x153E, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SET_PROJECTILE_POSITION,            0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SHOWTAXINODES,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SHOW_BANK,                          0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLENERGIZELOG,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SPELLHEALLOG,                       0x0114, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLNONMELEEDAMAGELOG,             0x11FB, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_CATEGORY_COOLDOWN,            0x082A, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_COOLDOWN,                     0x03F4, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_DELAYED,                      0x0134, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILED_OTHER,                 0x11DB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILURE,                      0x1A03, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_GO,                           0x1161, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_START,                        0x0803, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_STANDSTATE_UPDATE,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_START_MIRROR_TIMER,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_START_TIMER,                        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_STOP_DANCE,                         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_STOP_MIRROR_TIMER,                  0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TALENTS_INFO,                       0x012D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TALENTS_INVOLUNTARILY_RESET,        0x01E3, STATUS_UNHANDLED); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TEXT_EMOTE,                         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_CLEAR,                       0x030F, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_REMOVE,                      0x0F3D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_UPDATE,                      0x03A9, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TIME_ADJUSTMENT,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_TITLE_EARNED,                       0x1324, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TOGGLE_XP_GAIN,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TOTEM_CREATED,                      0x0352, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRAINER_LIST,                       0x0BA9, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_ABORTED,                   0x03C2, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_PENDING,                   0x172A, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_TRIGGER_CINEMATIC,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_TRIGGER_MOVIE,                      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_TURN_IN_PETITION_RESULTS,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_TUTORIAL_FLAGS,                     0x020F, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_ACCOUNT_DATA,                0x1520, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_ACCOUNT_DATA_COMPLETE,       0x0000, STATUS_UNHANDLED); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_LAST_INSTANCE,               0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                      0x122C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_SERVER_PLAYER_POSITION,      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_WORLD_STATE,                 0x03EC, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_VOID_STORAGE_CONTENTS,              0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_VOID_TRANSFER_RESULT,               0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WEATHER,                            0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_SERVER_INFO,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x0B83, STATUS_NEVER    ); // 6.0.2 18833
    DEFINE_OPCODE_HANDLER(SMSG_XP_GAIN_ABORTED,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_ZONE_UNDER_ATTACK,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(MSG_VERIFY_CONNECTIVITY,                 0x4F57, STATUS_NEVER    ); // Not an opcode

    ///< Garrison & Shipment
    DEFINE_OPCODE_HANDLER(SMSG_COMPLETE_SHIPMENT_RESPONSE,         0x1901, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_CREATE_SHIPMENT_RESPONSE,           0x1BAB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENT_INFO_RESPONSE,         0x1B81, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE,     0x11AB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP,      0x1974, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_RESULT,           0x0709, STATUS_NEVER    ); // 6.0.3 19103

    DEFINE_OPCODE_HANDLER(SMSG_GARR_ADD_FOLLOWER_RESULT,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_ADD_MISSION_RESULT,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING_RESULT, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_ACTIVATED,            0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_REMOVED,              0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_SET_ACTIVE_SPEC_RESULT, 0x0000, STATUS_NEVER  );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_COMPLETE_MISSION_RESULT,       0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_DELETE_RESULT,                 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_FOLLOWER_CHANGED_ITEM_LEVEL,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_FOLLOWER_CHANGED_XP,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LEARN_BLUEPRINT_RESULT,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LEARN_SPECIALIZATION_RESULT,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LIST_FOLLOWERS_CHEAT_RESULT,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_MISSION_BONUS_ROLL_RESULT,     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_ARCHITECT,                0x0523, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_MISSION_NPC,              0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLACE_BUILDING_RESULT,         0x0082, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_PLACED,                   0x0583, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GARR_PLOT_REMOVED,                  0x0513, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOTE_INFO,                   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING_RESULT, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOVE_FOLLOWER_RESULT,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REQUEST_BLUEPRINT_AND_SPEC_DATA_RESULT, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_GARR_START_MISSION_RESULT,          0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GARR_UPGRADE_RESULT,                0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GET_GARR_INFO_RESULT,               0x0521, STATUS_NEVER    ); // 6.0.3 19103

    ///< Movement
    DEFINE_OPCODE_HANDLER(SMSG_MONSTER_MOVE,                       0x0994, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_ROOT,                          0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_ACTIVE_MOVER,              0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_FLY,                   0x01F6, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_SPEED,              0x100B, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_SPEED,                 0x08F5, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_TELEPORT,                      0x03A6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNROOT,                        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_FLY,                 0x0BAE, STATUS_NEVER    ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,      0x1349, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,       0x02DE, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_DISABLE,        0x0A86, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_ENABLE,         0x0659, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_ROOT,                   0x1959, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_ANIM,               0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,       0x01FD, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,  0x0061, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,       0x060C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLYING,             0x02BD, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_HOVER,              0x0BD6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,          0x01BC, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,        0x11B1, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_PITCH_RATE,         0x045C, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,     0x0086, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_MODE,           0x0896, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_SPEED,          0x1B9A, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED,    0x0895, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_SPEED,         0x098D, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_TURN_RATE,          0x03F6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_MODE,          0x03D6, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_SPEED,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,         0x02D5, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,             0x01BB, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,              0x1391, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNROOT,                 0x03B2, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_FLYING,           0x09D9, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,            0x1B4A, STATUS_NEVER    ); // 6.0.3 19103

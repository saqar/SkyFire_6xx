...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ADDON_INFO,                         0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                     0x10AA, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                      0x0564, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                          0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_TIMEZONE_INFORMATION,           0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                      0x0000, STATUS_NEVER    ); 

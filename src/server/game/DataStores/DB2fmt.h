...
char const GarrAbilityCategoryEntryfmt[] = "is";
char const GarrBuildingEntryfmt[] = "iiiiiissssiiiiiiiiiiiiii";
char const GarrClassSpecEntryfmt[] = "isiiii";
char const GarrEncounterEntryfmt[] = "iisffi";
char const GarrFollItemSetEntryfmt[] = "i";
char const GarrFollowerEntryfmt[] = "iiiiiiiiiiiiiiiiiiiii";
char const GarrFollowerLevelXPEntryfmt[] = "iii";
char const GarrFollowerQualityEntryfmt[] = "iii";
char const GarrMissionEntryfmt[] = "iiiiiiiiiiisssiiiiii";
char const GarrMissionTypeEntryfmt[] = "isi";
char const GarrMechanicEntryfmt[] = "iif";
char const GarrPlotEntryfmt[] = "iiiisiiii";
char const GarrPlotBuildingEntryfmt[] = "iii";
char const GarrPlotUICategoryEntryfmt[] = "isi";
char const GarrSpecializationEntryfmt[] = "iiiiifiss";

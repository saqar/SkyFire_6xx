...
public:
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            cInfo->NameAlt            = fields[10].GetString();
            cInfo->SubName            = fields[11].GetString();
            cInfo->SubNameAlt         = fields[12].GetString();
            ...
            cInfo->family             = fields[38].GetUInt16();
            ...
            cInfo->FlagQuest          = fields[78].GetBool();

            for (uint8 i = 0; i < MAX_CREATURE_QUEST_ITEMS; ++i)
                cInfo->questItems[i] = fields[79 + i].GetUInt32();

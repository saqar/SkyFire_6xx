...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTSPECIAL_ANIM,                  0x1134, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_SPEED,                0x10DC, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_WALK_SPEED,             0x0590, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                          0x0003, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                      0x0AA3, STATUS_NEVER    ); // 6.0.2 18850

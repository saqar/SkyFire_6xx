...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ACTIVATETAXI,                       0x03C9, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiOpcode           ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_ACTIVATETAXIEXPRESS,                0x06FB, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiExpressOpcode    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTH_SESSION,                       0x1B05, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess               ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_ENUM,                          0x01EC, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode               ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,           0x109A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REFORGE_ITEM,                       0x0C4F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReforgeItemOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SETSHEATHED,                        0x03E6, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSheathedOpcode            );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                     0x10AA, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                      0x0564, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                          0x1154, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWNS,                    0x1458, STATUS_NEVER    ); // 5.4.8 18141
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_KILL,               0x1645, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SEND_UNLEARN_SPELLS,                0x0CE1, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_FACTION_STANDING,               0x0000, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_STANDSTATE_UPDATE,                  0x0000, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_START_MIRROR_TIMER,                 0x0000, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_START_TIMER,                        0x0000, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_STOP_DANCE,                         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_STOP_MIRROR_TIMER,                  0x0000, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SUSPEND_COMMS,                      0x1876, STATUS_UNHANDLED);

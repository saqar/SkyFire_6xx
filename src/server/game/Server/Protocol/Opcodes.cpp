...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    // Garrisons
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_BUILDING_ACTIVATED,        0x0151, STATUS_NEVER    ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_DELETE_RESULT,             0x097C, STATUS_UNHANDLED); // 6.0.3 19103

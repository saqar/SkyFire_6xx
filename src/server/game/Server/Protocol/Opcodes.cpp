...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DELETED,                 0x0138, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL,                 0x19A2, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED,   0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_DENINED,    0x1BEC, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUERY_NAME_RESPONSE,     0x09EC, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_SLOT_UPDATE,             0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UPDATE,                  0x0354, STATUS_NEVER    );

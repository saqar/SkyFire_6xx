...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_RECRUIT_FOLLOWER,              0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRecruitFollower          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA, 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRequestBlueprintData);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING,   0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrAssignFollower           );
    DEFINE_OPCODE_HANDLER(CMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING, 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrRemoveFollower           );
    DEFINE_OPCODE_HANDLER(CMSG_GARR_SWAP_BUILDING,                 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrSwapBuildings            );      
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_SHIPMENT_NPC,                  0x03D9, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleOpenShipmentNpc              ); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(CMSG_GET_SHIPMENT_INFO,                  0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGetShipmentInfo              );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CREATE_SHIPMENT,                    0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCreateShipment               );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_ALL_READY_SHIPMENTS,       0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteAllReadyShipment     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_MISSION_BONUS_ROLL,            0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrMissionBonusRoll         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SORT_BAGS,                          0x1399, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSortBagsOpcode               ); // 6.0.3 191039
    DEFINE_OPCODE_HANDLER(CMSG_SORT_BANK_BAGS,                     0x13BB, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSortBankBagsOpcode           ); // 6.0.3 191039

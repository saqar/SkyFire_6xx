...
enum Opcodes
{
    ...
    CMSG_GAMESPEED_SET,
    CMSG_GAMETIME_SET,
    CMSG_GARR_CREATE_CHEAT,
    CMSG_GARR_DELETE_CHEAT,
    CMSG_GARR_SET_LEVEL_CHEAT,
    CMSG_UPGRADE_GARR,
    CMSG_GARR_PLACE_BUILDING_CHEAT,
    CMSG_GARR_REMOVE_BUILDING_CHEAT,
    CMSG_GARR_UPGRADE_BUILDING_CHEAT,
    CMSG_GARR_LEARN_BUILDING_SPECIALIZATION_CHEAT,
    CMSG_GARR_SET_ACTIVE_BUILDING_SPECIALIZATION,
    CMSG_GARR_SET_ACTIVE_BUILDING_SPECIALIZATION_CHEAT,
    CMSG_GET_GARR_INFO,
    CMSG_GARR_GENERATE_RECRUITS,
    CMSG_GARR_RECRUIT_FOLLOWER,
    CMSG_GARR_LEARN_BLUEPRINT_CHEAT,
    CMSG_GARR_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA,
    CMSG_GARR_PURCHASE_BUILDING,
    CMSG_GARR_SET_BUILDING_ACTIVE,
    CMSG_GARR_FORCE_BUILDING_ACTIVE,
    CMSG_GARR_PORT_CHEAT,
    CMSG_GARR_ADD_FOLLOWER_XP_CHEAT,
    CMSG_GARR_SET_FOLLOWER_ITEM_LEVEL_CHEAT,
    CMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING,
    CMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING,
    CMSG_GARR_SWAP_BUILDING,
    ...
    CMSG_SHOW_BRAIN,
    CMSG_SHOW_GARR_TRANSFER,
    CMSG_GET_TROPHY_LIST,
    CMSG_REPLACE_TROPHY,
    CMSG_GARR_ADD_UNIQUE_FOLLOWER_CHEAT,
    CMSG_GARR_REMOVE_FOLLOWER_CHEAT,
    CMSG_GARR_LIST_FOLLOWERS_CHEAT,
    CMSG_GARR_ADD_MISSION_CHEAT,
    CMSG_GARR_START_MISSION,
    CMSG_GARR_COMPLETE_MISSION,
    CMSG_GARR_COMPLETE_MISSION_CHEAT,
    CMSG_GARR_MISSION_BONUS_ROLL,
    ...
    SMSG_CHAR_RENAME,
    SMSG_CHAR_UNDELETE_RESPONSE,
    SMSG_CHAR_UNDELETE_COOLDOWN_RESPONSE,
    ...
    SMSG_FRIEND_STATUS,
    SMSG_GET_GARR_INFO_RESULT,
    SMSG_GARR_PLOT_PLACED,
    SMSG_GARR_PLOT_REMOVED,
    SMSG_GARR_PLACE_BUILDING_RESULT,
    SMSG_GARR_BUILDING_REMOVED,
    SMSG_GARR_LEARN_SPECIALIZATION_RESULT,
    SMSG_GARR_BUILDING_SET_ACTIVE_SPEC_RESULT,
    SMSG_GARR_LEARN_BLUEPRINT_RESULT,
    SMSG_GARR_REQUEST_BLUEPRINT_AND_SPEC_DATA_RESULT,
    SMSG_GARR_REMOTE_INFO,
    SMSG_GARR_BUILDING_ACTIVATED,
    SMSG_GARR_UPGRADE_RESULT,
    SMSG_GARR_ADD_FOLLOWER_RESULT,
    SMSG_GARR_REMOVE_FOLLOWER_RESULT,
    SMSG_GARR_LIST_FOLLOWERS_CHEAT_RESULT,
    SMSG_GARR_ADD_MISSION_RESULT,
    SMSG_GARR_START_MISSION_RESULT,
    SMSG_GARR_COMPLETE_MISSION_RESULT,
    SMSG_GARR_MISSION_BONUS_ROLL_RESULT,
    SMSG_GARR_FOLLOWER_CHANGED_XP,
    SMSG_GARR_FOLLOWER_CHANGED_ITEM_LEVEL,
    SMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING_RESULT,
    SMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING_RESULT,
    SMSG_GARR_DELETE_RESULT,
    SMSG_GARR_OPEN_ARCHITECT,
    SMSG_GARR_OPEN_MISSION_NPC,
    ...
    SMSG_GUILD_MEMBERS_WITH_REPICE,
    ...
    SMSG_SET_LFG_FAST_LAUNCH_RESULT,
    ...
    SMSG_LOG_XPGAIN,
    SMSG_LOOT_AE_TARGET_ACK,
    SMSG_LOOT_AE_TARGETS,

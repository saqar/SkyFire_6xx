...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TELEPORT_ACK,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck              );
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_TIME_SKIPPED,                  0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMoveTimeSkippedOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_CAST_SPELL,                     0x0286, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetCastSpellOpcode           ); // 6.0.3 19103
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,      0x1349, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,       0x02DE, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_DISABLE,        0x0A86, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_ENABLE,         0x0659, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_ROOT,                   0x1959, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_ANIM,               0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,       0x01FD, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,  0x0061, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,       0x060C, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLYING,             0x02BD, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_HOVER,              0x0BD6, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,          0x01BC, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,        0x11B1, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_PITCH_RATE,         0x045C, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,     0x0086, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_MODE,           0x0896, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_SPEED,          0x1B9A, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED,    0x0895, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_SPEED,         0x098D, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_TURN_RATE,          0x03F6, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_MODE,          0x03D6, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_SPEED,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,         0x02D5, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,             0x01BB, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,              0x1391, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNROOT,                 0x03B2, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_FLYING,           0x09D9, STATUS_UNHANDLED); // 6.0.3 19103
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,            0x1B4A, STATUS_UNHANDLED); // 6.0.3 19103

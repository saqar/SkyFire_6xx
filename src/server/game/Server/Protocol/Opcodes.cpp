...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTH_SESSION,                       0x1B05, STATUS_UNHANDLED,   PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess               ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_TRADE,                       0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelTradeOpcode            ); 
    DEFINE_OPCODE_HANDLER(CMSG_CAST_SPELL,                         0x0000, STATUS_UNHANDLED,  PROCESS_THREADSAFE,   &WorldSession::HandleCastSpellOpcode              ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CREATE,                        0x10F3, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCreateOpcode             ); 
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCustomize                ); 
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_DELETE,                        0x08FC, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharDeleteOpcode             ); 
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_ENUM,                          0x01EC, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode               ); // 6.0.2 18833 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CREATURE_QUERY,                     0x0000, STATUS_UNHANDLED,  PROCESS_INPLACE,      &WorldSession::HandleCreatureQueryOpcode          ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJECT_QUERY,                   0x0000, STATUS_UNHANDLED,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectQueryOpcode        ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_NOTE,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTabNote             ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_TALENT,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLearnTalentOpcode            ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOG_DISCONNECT,                     0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); 
    DEFINE_OPCODE_HANDLER(CMSG_LOOT,                               0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode                   ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_MONEY,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMoneyOpcode              ); 
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_RELEASE,                       0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootReleaseOpcode            ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_SAY,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                         0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode              ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NPC_TEXT_QUERY,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNpcTextQueryOpcode           ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PLAYER_LOGIN,                       0x0000, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLoginOpcode            ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PVP_LOG_DATA,                       0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePVPLogDataOpcode             ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_ACCEPT_QUEST,            0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverAcceptQuestOpcode  ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CHOOSE_REWARD,           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverChooseRewardOpcode ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_COMPLETE_QUEST,          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCompleteQuest      ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_HELLO,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverHelloOpcode        ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUERY_QUEST,             0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQueryQuestOpcode   ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_REQUEST_REWARD,          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverRequestRewardOpcode); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_QUERY,            0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverStatusQueryOpcode  ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_REMOVE_QUEST,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogRemoveQuest          ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_POI_QUERY,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPOIQuery                ); 
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_QUERY,                        0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestQueryOpcode             ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                     0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix                ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SELL_ITEM,                          0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSellItemOpcode               ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTION_BUTTON,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionButtonOpcode        ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PRIMARY_TALENT_TREE,            0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandeSetTalentSpecialization       ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_SELECTION,                      0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode           ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_INV_ITEM,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSwapInvItemOpcode            ); 
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x0000, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleWorldStateUITimerUpdate      ); 
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_JUMP,                           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                   0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                  0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_ASCEND,                   0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                 0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                  0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_PITCH_DOWN,               0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_PITCH_UP,                 0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,              0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,             0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,               0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP,                           0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_ASCEND,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_PITCH,                     0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                    0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                      0x0000, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); 
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_WORLDPORT_ACK,                  0x0000, STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode       ); 
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACCOUNT_DATA_TIMES,                 0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACHIEVEMENT_EARNED,                 0x13BB, STATUS_NEVER    ); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_ACTION_BUTTONS,                     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_ACTIVATETAXIREPLY,                  0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_ADDON_INFO,                         0x0000, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKERSTATEUPDATE,                0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTART,                        0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTOP,                         0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AURA_UPDATE,                        0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                     0x10AA, STATUS_NEVER    ); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                      0x0564, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS,                 0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_QUEUED,          0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_ACTIVE,          0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION, 0x0000, STATUS_NEVER   ); 
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS,   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_FAILED,          0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BINDPOINTUPDATE,                    0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CREATE,                        0x13E8, STATUS_NEVER    ); // 6.0.2 18833
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_DELETE,                        0x13FC, STATUS_NEVER    ); // 6.0.2 18833 
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                          0x1154, STATUS_NEVER    ); // 6.0.2 18833 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                0x08EB, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CREATURE_QUERY_RESPONSE,            0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DB_REPLY,                           0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COMPLETE,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_COUNTDOWN,                     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_INBOUNDS,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_OUTOFBOUNDS,                   0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_REQUESTED,                     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_DUEL_WINNER,                        0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_QUERY_RESPONSE,          0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_BUILDING_ACTIVATE,         0x1898, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_BUILDING_SET_ACTIVE_SPEC,  0x0139, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_DELETE_RESULT,             0x0419, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_LEARN_BLUEPRINT_RESULT,    0x0079, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_LIST_FOLLOWER_CHEAT_RESULT,0x0129, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_OPEN_ARCHITECT,            0x0429, STATUS_UNHANDLED); // 6.0.2 18850          
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_PLACE_BUILDING_RESULT,     0x18D4, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_PLOT_PLACED,               0x001A, STATUS_UNHANDLED); // 6.0.2 18850      
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_PLOT_REMOVED,              0x012A, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_START_MISSION_RESULT,      0x042A, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_GARRISON_UPGRADE_RESULT,            0x1109, STATUS_UNHANDLED); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_COMPLETE,                    0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_MESSAGE,                     0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_INVITE,                       0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_LIST,                         0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_BANK_MONEY_CHANGED,     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_BANK_TAB_ADDED,         0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_BANK_TAB_TEXT_CHANGED,  0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_BANK_TAB_MODIFIED,      0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE,                       0x1209, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INITIAL_SPELLS,                     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_INIT_WORLD_STATES,                  0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INVENTORY_CHANGE_FAILURE,           0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                   0x13F4, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                      0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PLAYER_INFO,                    0x0005, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LIST_INVENTORY,                     0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOAD_CUF_PROFILES,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_SETTIMESPEED,                 0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_VERIFY_WORLD,                 0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_CANCEL_ACK,                  0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_COMPLETE,                    0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_RESPONSE,                    0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CLEAR_MONEY,                   0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MONEY_NOTIFY,                  0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RELEASE_RESPONSE,              0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_REMOVED,                       0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RESPONSE,                      0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MESSAGECHAT,                        0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MONSTER_MOVE,                       0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTSPECIAL_ANIM,                  0x1134, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_FLY,                   0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_SPEED,              0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_SPEED,                 0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_SPEED,                0x10DC, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_TELEPORT,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNROOT,                        0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_FLY,                 0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_WALK_SPEED,             0x0590, STATUS_UNHANDLED); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NAME_QUERY_RESPONSE,                0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                          0x0003, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NPC_TEXT_UPDATE,                    0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_CONTAINER,                     0x01C0, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_LFG_DUNGEON_FINDER,            0x0001, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PARTY_COMMAND_RESULT,               0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYERBOUND,                        0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                        0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_POWER_UPDATE,                       0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PVP_LOG_DATA,                       0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_PVP_OPTIONS_ENABLED,                0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PVP_SEASON,                         0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_OFFER_REWARD,            0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_COMPLETE,          0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_DETAILS,           0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_LIST,              0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_REQUEST_ITEMS,           0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS,                  0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS_MULTIPLE,         0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTLOG_FULL,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_KILL,               0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_PVP_KILL,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_COMPLETE,               0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_CONFIRM_ACCEPT,               0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_POI_QUERY_RESPONSE,           0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_QUERY_RESPONSE,               0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_READ_ITEM_OK,                       0x1743, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_TIMEZONE_INFORMATION,           0x0BEF, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLINTERRUPTLOG,                  0x0EEF, STATUS_NEVER    ); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLNONMELEEDAMAGELOG,             0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_DELAYED,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILED_OTHER,                 0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILURE,                      0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_GO,                           0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_START,                        0x0000, STATUS_NEVER    ); 
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_UPDATE_CHAIN_TARGETS,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPIRIT_HEALER_CONFIRM,              0x1527, STATUS_NEVER    ); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,      0x0CF4, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,       0x04A3, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_DISABLE,        0x04C2, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_ENABLE,         0x008B, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_ROOT,                   0x0B90, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_ANIM,               0x0000, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,       0x048B, STATUS_UNHANDLED); // 6.0.2 18850 
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,  0x07E9, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,       0x05D8, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLYING,             0x118F, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_HOVER,              0x05C1, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,          0x07E2, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,        0x058F, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_PITCH_RATE,         0x1093, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,     0x1AA0, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_MODE,           0x1093, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_SPEED,          0x1B97, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED,    0x04A3, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_SPEED,         0x01CB, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_TURN_RATE,          0x1BE0, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_MODE,          0x0AC7, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_SPEED,         0x0000, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,         0x11C8, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,             0x0D88, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,              0x059B, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNROOT,                 0x05B3, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_FLYING,           0x0CEB, STATUS_UNHANDLED); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,            0x04B3, STATUS_UNHANDLED); // 6.0.2 18850
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TALENTS_INFO,                       0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_PENDING,                   0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TUTORIAL_FLAGS,                     0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                      0x03EF, STATUS_NEVER    ); // 6.0.2 18850
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_SERVER_PLAYER_POSITION,      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_WORLD_STATE,                 0x0000, STATUS_NEVER    ); 
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x0000, STATUS_NEVER    ); 

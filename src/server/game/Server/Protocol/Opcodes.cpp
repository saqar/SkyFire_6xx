...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,        0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS,   0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_LEADERS,     0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_LEADERS_CHEAT, 0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                      );
    DEFINE_OPCODE_HANDLER(CMSG_GET_CHALLENGE_MODE_REWARDS,         0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_DUMP_LEADERS,        0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_DELETE_LEADER,       0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_RESET_CHALLENGE_MODE,               0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_FINISH_CHALLENGE_MODE_CHEAT,        0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_CHEAT,               0x2000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GARR_PURCHASE_BUILDING,             0x04A2, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGarrPurchaseBuilding         ); // 6.0.3 19103
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_SHIPMENT_NP_C,                 0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                        );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE, 0x0000, STATUS_NEVER  );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE, 0x0000, STATUS_NEVER );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE, 0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_MAKE_PRODUCT_CHOICE_RESPONSE, 0x0000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_PURCHASE_UPDATE,         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_CONFIRM_PURCHASE,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_ACK_FAILED,              0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE,     0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_STARTED,        0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_ENDED,          0x0000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_COMPLETE,            0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REWARDS,             0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_ALL_MAP_STATS,       0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE,    0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT, 0x2000, STATUS_NEVER);
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD,   0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_SET_ITEM_CHALLENGE_MODE_DATA,       0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_ITEM_CHALLENGE_MODE_DATA,     0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_DUMP_LEADERS_RESULT, 0x2000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_DELETE_LEADER_RESULT,0x2000, STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP,      0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENT_INFO_RESPONSE,         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_OPEN_SHIPMENT_NPC_RESULT,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_CREATE_SHIPMENT_RESPONSE,           0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_COMPLETE_SHIPMENT_RESPONSE,         0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE,     0x0000, STATUS_NEVER    );

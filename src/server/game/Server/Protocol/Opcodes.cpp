...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARR_ADD_FOLLOWER_RESULT,                        0x1973, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_ADD_MISSION_RESULT,                         0x0503, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_ASSIGN_FOLLOWER_TO_BUILDING_RESULT,         0x0D54, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_ACTIVATED,                         0x0151, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_REMOVED,                           0x1151, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_BUILDING_SET_ACTIVE_SPEC_RESULT,            0x0282, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_COMPLETE_MISSION_RESULT,                    0x0544, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_DELETE_RESULT,                              0x097C, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_FOLLOWER_CHANGED_ITEM_LEVEL,                0x0D01, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_FOLLOWER_CHANGED_XP,                        0x0973, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LEARN_BLUEPRINT_RESULT,                     0x000B, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LEARN_SPECIALIZATION_RESULT,                0x01D1, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_LIST_FOLLOWERS_CHEAT_RESULT,                0x096B, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_MISSION_BONUS_ROLL_RESULT,                  0x196A, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_ARCHITECT,                             0x0523, STATUS_NEVER    ); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_OPEN_MISSION_NPC,                           0x0952, STATUS_UNHANDLED); // 6.0.3 19116
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOTE_INFO,                                0x0964, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOVE_FOLLOWER_FROM_BUILDING_RESULT,       0x0B7A, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REMOVE_FOLLOWER_RESULT,                     0x196C, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_REQUEST_BLUEPRINT_AND_SPEC_DATA_RESULT,     0x0D14, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_START_MISSION_RESULT,                       0x0D51, STATUS_UNHANDLED); // 6.0.3 19116
    DEFINE_OPCODE_HANDLER(SMSG_GARR_UPGRADE_RESULT,                             0x0739, STATUS_UNHANDLED); // 6.0.3 19116

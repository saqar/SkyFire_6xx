...
enum Difficulty
{
    ...
    DUNGEON_DIFFICULTY_EVENT     = 3,

    RAID_DIFFICULTY_10MAN_NORMAL = 0,
    RAID_DIFFICULTY_25MAN_NORMAL = 1,
    RAID_DIFFICULTY_10MAN_HEROIC = 2,
    RAID_DIFFICULTY_25MAN_HEROIC = 3,
    RAID_DIFFICULTY_RAID_FINDER  = 4,
    RAID_DIFFICULTY_40MAN        = 5,
    RAID_DIFFICULTY_NORMAL       = 6,  // 10MAN_FLEX was removed because in 6.x.x Normal and Heroic difficulties are flexible regardless.
    RAID_DIFFICULTY_HEROIC       = 7,  // 10MAN_FLEX was removed because in 6.x.x Normal and Heroic difficulties are flexible regardless.
    RAID_DIFFICULTY_MYTHIC       = 8,
    RAID_DIFFICULTY_LFR          = 9,
    RAID_DIFFICULTY_EVENT        = 10,

    SCENARIO_DIFFICULTY_NORMAL   = 0,  // Maxmimum 3 players
    SCENARIO_DIFFICULTY_HEROIC   = 1,  // Maximium 5 players
    SCENARIO_DIFFICULTY_EVENT    = 2   // Maximum 25 players
};
...
#define MAX_RAID_DIFFICULTY        11
#define MAX_SCENARIO_DIFFICULTY    3
...
enum SpawnMask
{
    ...
    SPAWNMASK_DUNGEON_EVENT         = (1 << DUNGEON_DIFFICULTY_EVENT),
    SPAWNMASK_DUNGEON_ALL           = (SPAWNMASK_DUNGEON_NORMAL | SPAWNMASK_DUNGEON_HEROIC | SPAWNMASK_DUNGEON_CHALLENGE | SPAWNMASK_DUNGEON_EVENT),

    SPAWNMASK_RAID_10MAN_NORMAL     = (1 << RAID_DIFFICULTY_10MAN_NORMAL),
    SPAWNMASK_RAID_25MAN_NORMAL     = (1 << RAID_DIFFICULTY_25MAN_NORMAL),
    SPAWNMASK_RAID_FINDER           = (1 << RAID_DIFFICULTY_RAID_FINDER),
    SPAWNMASK_RAID_40MAN            = (1 << RAID_DIFFICULTY_40MAN),
    SPAWNMASK_RAID_NORMAL_ALL       = (SPAWNMASK_RAID_10MAN_NORMAL | SPAWNMASK_RAID_25MAN_NORMAL | SPAWNMASK_RAID_FINDER | SPAWNMASK_RAID_40MAN),
    ...
    SPAWNMASK_RAID_NORMAL           = (1 << RAID_DIFFICULTY_NORMAL),
    SPAWNMASK_RAID_HEROIC           = (1 << RAID_DIFFICULTY_HEROIC),
    SPAWNMASK_RAID_MYTHIC           = (1 << RAID_DIFFICULTY_MYTHIC),
    SPAWNMASK_RAID_LFR              = (1 << RAID_DIFFICULTY_LFR),
    SPAWNMASK_RAID_EVENT            = (1 << RAID_DIFFICULTY_EVENT),
    SPAWNMASK_RAID_WOD_ALL          = (SPAWNMASK_RAID_NORMAL | SPAWNMASK_RAID_HEROIC | SPAWNMASK_RAID_MYTHIC | SPAWNMASK_RAID_LFR | SPAWNMASK_RAID_EVENT),

    SPAWNMASK_RAID_ALL              = (SPAWNMASK_RAID_NORMAL_ALL | SPAWNMASK_RAID_HEROIC_ALL | SPAWNMASK_RAID_WOD_ALL),

    SPAWNMASK_SCENARIO_NORMAL       = (1 << SCENARIO_DIFFICULTY_NORMAL),
    SPAWNMASK_SCENARIO_HEROIC       = (1 << SCENARIO_DIFFICULTY_HEROIC),
    SPAWNMASK_SCENARIO_EVENT        = (1 << SCENARIO_DIFFICULTY_EVENT),
    SPAWNMASK_SCENARIO_ALL          = (SCENARIO_DIFFICULTY_NORMAL | SCENARIO_DIFFICULTY_HEROIC | SPAWNMASK_SCENARIO_EVENT)
};
...
enum CurrencyTypes
{
    CURRENCY_TYPE_CURRENCY_TOKEN_TEST_TOKEN_4           = 1,
    ...
    CURRENCY_TYPE_ZZZOLDDAILY_QUEST_FACTION_TOKEN       = 141,
    ...
    CURRENCY_TYPE_ZEN_JEWELCRAFTERS_TOKEN               = 698,
